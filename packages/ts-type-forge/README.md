...
- src/branded-types/predefined-arrays/length-constrained-array-ops.mts
    ...
    - [ConstrainedList.TakeLast](./src/branded-types/predefined-arrays/length-constrained-array-ops.mts#L162)
    - [ConstrainedList.Skip](./src/branded-types/predefined-arrays/length-constrained-array-ops.mts#L179)
    - [ConstrainedList.SkipLast](./src/branded-types/predefined-arrays/length-constrained-array-ops.mts#L193)
    - [ConstrainedList.Concat](./src/branded-types/predefined-arrays/length-constrained-array-ops.mts#L210)
    - [ConstrainedList.Zip](./src/branded-types/predefined-arrays/length-constrained-array-ops.mts#L230)
    - [ConstrainedList.Head](./src/branded-types/predefined-arrays/length-constrained-array-ops.mts#L255)
    - [ConstrainedList.Last](./src/branded-types/predefined-arrays/length-constrained-array-ops.mts#L271)
    - [ConstrainedList.Partition](./src/branded-types/predefined-arrays/length-constrained-array-ops.mts#L286)
    - [FromBounds](./src/branded-types/predefined-arrays/length-constrained-array-ops.mts#L346)
    - [NormalizeLengthConstraint](./src/branded-types/predefined-arrays/length-constrained-array-ops.mts#L407)
...
- src/tuple-and-list/tuple.mts
    ...
    - [Tuple.Take](./src/tuple-and-list/tuple.mts#L110)
    - [Tuple.Skip](./src/tuple-and-list/tuple.mts#L131)
    - [Tuple.TakeLast](./src/tuple-and-list/tuple.mts#L152)
    - [Tuple.SkipLast](./src/tuple-and-list/tuple.mts#L173)
    - [Tuple.SetAt](./src/tuple-and-list/tuple.mts#L200)
    - [Tuple.Flatten](./src/tuple-and-list/tuple.mts#L220)
    - [Tuple.Concat](./src/tuple-and-list/tuple.mts#L244)
    - [Tuple.Zip](./src/tuple-and-list/tuple.mts#L261)
    - [Tuple.Partition](./src/tuple-and-list/tuple.mts#L281)
